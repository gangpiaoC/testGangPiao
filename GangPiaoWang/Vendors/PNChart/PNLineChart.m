...
- (void)drawRect:(CGRect)rect {
    if (self.isShowCoordinateAxis) {
        ...
        UIFont *font = [UIFont systemFontOfSize:11 weight:UIFontWeightLight];
...
- (UIView *)getLegendWithMaxWidth:(CGFloat)mWidth {
    ...
    CGFloat singleRowHeight = [PNLineChart sizeOfString:@"Test"
                                              withWidth:MAXFLOAT
                                                   font:self.legendFont ? self.legendFont : [UIFont systemFontOfSize:12.0f weight:UIFontWeightLight]].height;
    ...
    for (PNLineChartData *pdata in self.chartData) {
        ...
        CGSize labelsize = [PNLineChart sizeOfString:pdata.dataTitle
                                           withWidth:maxLabelWidth
                                                font:self.legendFont ? self.legendFont : [UIFont systemFontOfSize:12.0f weight:UIFontWeightLight]];
        ...
        label.font = self.legendFont ? self.legendFont : [UIFont systemFontOfSize:12.0f weight:UIFontWeightLight];
