...
- (id)initWithFrame:(CGRect)frame items:(NSArray *)items valueDivider:(CGFloat)unitValue {
    ...
    if (self) {
        ...
        _detailLabel.font = [UIFont systemFontOfSize:15 weight:UIFontWeightLight];
...
- (void)drawLabelWithMaxLength:(CGFloat)maxLength labelArray:(NSArray *)labelArray angleArray:(NSArray *)angleArray {
    ...
    for (NSString *labelString in labelArray) {
        ...
        label.font = [UIFont systemFontOfSize:_fontSize weight:UIFontWeightLight];
        label.text = labelString;
        label.tag = labelTag;
        CGSize detailSize = [labelString sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:_fontSize weight:UIFontWeightLight]}];
...
- (void)showGraduation {
    ...
    for (NSArray *pointsArray in _pointsToWebArrayArray) {
        ...
        graduationLabel.font = [UIFont systemFontOfSize:ceil(_lengthUnit) weight:UIFontWeightLight];
...
- (CGFloat)getMaxWidthLabelFromArray:(NSArray *)keyArray withFontSize:(CGFloat)size {
    ...
    for (NSString *str in keyArray) {
        CGSize detailSize = [str sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:_fontSize weight:UIFontWeightLight]}];
